...
#include <fstream>
#include <iostream>
#include "site_ycsb_db_wisckey_Wisckey.h"
#include "site_ycsb_db_wisckey_Iterator.h"
#include "site_ycsb_db_wisckey_ReadOptions.h"
...
JNIEXPORT jboolean JNICALL Java_site_ycsb_db_wisckey_Wisckey_init(JNIEnv *env, jobject thisobj)
{
    ...
    { // default jason
        file_content = R"({"dir":"/mnt/kvs/scratch/wisckey/",
        				    "data_cache_size":16,
...
JNIEXPORT jbyteArray JNICALL Java_site_ycsb_db_wisckey_Wisckey_get(JNIEnv *env, jobject,
...
JNIEXPORT jboolean JNICALL Java_site_ycsb_db_wisckey_Wisckey_insert(JNIEnv *env, jobject,
...
JNIEXPORT jboolean JNICALL Java_site_ycsb_db_wisckey_Wisckey_update(JNIEnv *env, jobject,
                                                                    jbyteArray jkey, jint jkey_len,
                                                                    jbyteArray jval, jint jval_len)
{
    wisckey::Status ret;
...
JNIEXPORT jboolean JNICALL Java_site_ycsb_db_wisckey_Wisckey_delete(JNIEnv *env, jobject,
                                                                    jbyteArray jkey, jint jkey_len)
{
    wisckey::Status ret;
...
JNIEXPORT void JNICALL Java_site_ycsb_db_wisckey_Iterator_init(JNIEnv *env, jobject thisobj,
...
JNIEXPORT void JNICALL Java_site_ycsb_db_wisckey_Iterator_destory(JNIEnv *env, jobject thisobj)
{
...
JNIEXPORT void JNICALL Java_site_ycsb_db_wisckey_Iterator_seek(JNIEnv *env, jobject thisobj,
                                                               jbyteArray jkey, jint jkey_len)
{
...
JNIEXPORT void JNICALL Java_site_ycsb_db_wisckey_Iterator_next(JNIEnv *env, jobject thisobj)
{
    wisckey::Iterator *it = _IT_get_cpp_ptr(env, thisobj);
    it->Next();
}

JNIEXPORT jboolean JNICALL Java_site_ycsb_db_wisckey_Iterator_valid(JNIEnv *env, jobject thisobj)
{
    wisckey::Iterator *it = _IT_get_cpp_ptr(env, thisobj);
    return it->Valid();
}

JNIEXPORT jbyteArray JNICALL Java_site_ycsb_db_wisckey_Iterator_key(JNIEnv *env, jobject thisobj)
{
    wisckey::Iterator *it = _IT_get_cpp_ptr(env, thisobj);
...
JNIEXPORT jbyteArray JNICALL Java_site_ycsb_db_wisckey_Iterator_value(JNIEnv *env, jobject thisobj)
{
    wisckey::Iterator *it = _IT_get_cpp_ptr(env, thisobj);
...
JNIEXPORT void JNICALL Java_site_ycsb_db_wisckey_ReadOptions_init(JNIEnv *env, jobject thisobj,
                                                                  jbyteArray jkey, jint jkey_len)
{
...
JNIEXPORT void JNICALL Java_site_ycsb_db_wisckey_ReadOptions_destory(JNIEnv *env, jobject thisobj)
{
