...
public class PebblesDBClient extends DB {
  ...
  private static String pebblesDBPath;
  ...
  private static synchronized void getDBInstance() {
    if (db == null) {
      ...
      try {
        db = factory.open(new File(pebblesDBPath), options);
      } catch (IOException e) {
  ...
  public void init() throws DBException {
    pebblesDBPath = getProperties().getProperty("pebblesdb.path", "leveldb_database");
